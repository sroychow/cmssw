...
public:
  ...
  void fillHistosForRecHit(const DetId& id, const float xG, const float yG, const float zG, const float rG, const float fphi, const uint32_t charge = 0, const int16_t sizeX = 0, const int16_t sizeY = 0);
