#ifndef HiggsTripleMuonMonitor_H
#define HiggsTripleMuonMonitor_H
...
class HiggsTripleMuonMonitor : public DQMEDAnalyzer 
{
public:
  HiggsTripleMuonMonitor( const edm::ParameterSet& );
  ~HiggsTripleMuonMonitor();
...
#endif // HiggsTripleMuonMonitor_H
