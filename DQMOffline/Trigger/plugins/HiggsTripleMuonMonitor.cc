#include "DQMOffline/Trigger/plugins/HiggsTripleMuonMonitor.h"
...
HiggsTripleMuonMonitor::HiggsTripleMuonMonitor( const edm::ParameterSet& iConfig ) : 
...
MEbinning HiggsTripleMuonMonitor::getHistoLSPSet(edm::ParameterSet pset)
{
  return MEbinning{
    pset.getParameter<int32_t>("nbins"),
      0.,
...
void HiggsTripleMuonMonitor::setMETitle(LEPME& me, std::string titleX, std::string titleY)
{
...
void HiggsTripleMuonMonitor::bookME(DQMStore::IBooker &ibooker, LEPME& me, const std::string& histname, const std::string& histtitle, int nbins, double min, double max)
{
  me.numerator   = ibooker.book1D(histname+"_numerator",   histtitle+" (numerator)",   nbins, min, max);
  me.denominator = ibooker.book1D(histname+"_denominator", histtitle+" (denominator)", nbins, min, max);
}
void HiggsTripleMuonMonitor::bookME(DQMStore::IBooker &ibooker, LEPME& me, const std::string& histname, const std::string& histtitle, const std::vector<double>& binning)
{
...
void HiggsTripleMuonMonitor::bookME(DQMStore::IBooker &ibooker, LEPME& me, const std::string& histname, const std::string& histtitle, int nbinsX, double xmin, double xmax, double ymin, double ymax)
{
  me.numerator   = ibooker.bookProfile(histname+"_numerator",   histtitle+" (numerator)",   nbinsX, xmin, xmax, ymin, ymax);
  me.denominator = ibooker.bookProfile(histname+"_denominator", histtitle+" (denominator)", nbinsX, xmin, xmax, ymin, ymax);
}
void HiggsTripleMuonMonitor::bookME(DQMStore::IBooker &ibooker, LEPME& me, const std::string& histname, const std::string& histtitle, int nbinsX, double xmin, double xmax, int nbinsY, double ymin, double ymax)
{
  me.numerator   = ibooker.book2D(histname+"_numerator",   histtitle+" (numerator)",   nbinsX, xmin, xmax, nbinsY, ymin, ymax);
  me.denominator = ibooker.book2D(histname+"_denominator", histtitle+" (denominator)", nbinsX, xmin, xmax, nbinsY, ymin, ymax);
}
void HiggsTripleMuonMonitor::bookME(DQMStore::IBooker &ibooker, LEPME& me, const std::string& histname, const std::string& histtitle, const std::vector<double>& binningX, const std::vector<double>& binningY)
{
...
void HiggsTripleMuonMonitor::bookHistograms(DQMStore::IBooker     & ibooker,
				 edm::Run const        & iRun,
...
{  
  ...
  histname = "lep1Pt"; histtitle = "Leading  muon p_T";
  ...
  histname = "lep1Pt_variable"; histtitle = "Leading muon p_{T}";
  ...
  histname = "lep1PtVsLS"; histtitle = "Laading muon p_T vs LS";
  ...
  histname = "lep1Phi"; histtitle = "Leading muon phi";
  ...
  histname = "lep1Eta"; histtitle = "Leading muon #eta";
  ...
  histname = "lep1PtEta"; histtitle = "Leading muon pt-#eta";
  ...
  //Subleading
  histname = "lep2Pt"; histtitle = "Sub-leading muon p_T";
  ...
  histname = "lep2Pt_variable"; histtitle = "Sub-leading muon p_T";
  ...
  histname = "lep2PtVsLS"; histtitle = "Sub-leading muon p_T vs LS";
  ...
  histname = "lep2Phi"; histtitle = "Sub-leading muon phi";
  ...
  histname = "lep2Eta"; histtitle = "Sub-leading muon #eta";
  ...
  histname = "lep2PtEta"; histtitle = "Sub-leading muon pt-#eta";
  ...
  histname = "lep3Pt"; histtitle = "Trailing muon p_T";
  ...
  histname = "lep3Pt_variable"; histtitle = "Trailing muon p_{T}";
  ...
  histname = "lep3PtVsLS"; histtitle = "Trailing muon p_T vs LS";
  ...
  histname = "lep3Phi"; histtitle = "Trailing muon phi";
  ...
  histname = "lep3Eta"; histtitle = "Trailing muon #eta";
  ...
  histname = "lep3PtEta"; histtitle = "Trailing muon pt-#eta";
...
void HiggsTripleMuonMonitor::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup)  {
  ...
  //check the no. of muons after selection is applied
...
void HiggsTripleMuonMonitor::fillHistoPSetDescription(edm::ParameterSetDescription & pset)
{
  pset.add<int>   ( "nbins");
...
void HiggsTripleMuonMonitor::fillHistoLSPSetDescription(edm::ParameterSetDescription & pset)
{
  pset.add<int>   ( "nbins", 2500);
}

void HiggsTripleMuonMonitor::fillDescriptions(edm::ConfigurationDescriptions & descriptions)
{
  edm::ParameterSetDescription desc;
  desc.add<std::string>  ( "FolderName", "HLT/Higgs/TriLepton/TripleEle" );
  ...
  descriptions.add("higgsTripleMuonMonitoring", desc);
}

// Define this as a plug-in
#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(HiggsTripleMuonMonitor);
