...
# with command line options: step3 --conditions auto:phase1_2018_realistic -n 10 --era Run2_2018 --eventcontent RECOSIM,DQM --procModifiers gpu -s RAW2DIGI:RawToDigi_pixelOnly,RECO:reconstruction_pixelTrackingOnly,VALIDATION:@pixelTrackingOnlyValidation,DQM:@pixelTrackingOnlyDQM --datatier GEN-SIM-RECO,DQMIO --geometry DB:Extended --no_exec --filein file:step2.root --fileout file:step3.root
...
print("DIGI step modules:")
print(moduleLabelsInSequences(process.raw2digi_step))

print("RECO step modules:")
print(moduleLabelsInSequences(process.reconstruction_step))

process.load('hybrid')

print("DIGI step modules in legacy:")
print(moduleLabelsInSequences(process.raw2digi_steplegacy))
